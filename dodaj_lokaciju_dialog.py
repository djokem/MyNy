...
# Form implementation generated from reading ui file 'dodaj_lokaciju_dialog.ui'
#
...
class Ui_lokacijeDetalji(object):
    def setupUi(self, lokacijeDetalji):
        ...
        self.nazivTxt = QtWidgets.QLineEdit(self.groupBox)
        self.nazivTxt.setObjectName("nazivTxt")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.nazivTxt)
        self.mestoTxt = QtWidgets.QLineEdit(self.groupBox)
        self.mestoTxt.setObjectName("mestoTxt")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.mestoTxt)
        self.adresaTxt = QtWidgets.QLineEdit(self.groupBox)
        self.adresaTxt.setObjectName("adresaTxt")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.adresaTxt)
    ...
    def retranslateUi(self, lokacijeDetalji):
        ...
        lokacijeDetalji.setWindowTitle(_translate("lokacijeDetalji", "Dodaj lokaciju"))
        self.groupBox.setTitle(_translate("lokacijeDetalji", "Dodaj lokaciju"))
